...
?>
   <div id="padding:2px;width:100%;" style="margin-left: 18px;">
   		<table><tr>
   			<td><img src="<?php echo DOMAIN ?>images/counter.png" style="margin-top: 10px;"></td>
   			<td id="txt_counter">
   				  Đang truy cập: <span><?php echo $online; ?> </span><br />   
			      Hôm nay: <span><?php echo $day; ?> </span><br />
			     <!-- Hôm qua: <span><?php echo $yesterday; ?> </span><br /> 
			      Truy cập trong tuần: <span><?php echo $week; ?> </span><br /> -->
			      Tháng hiện tại: <span><?php echo $month; ?> </span><br />
			      Tổng lượt truy cập: <span><?php echo $all; ?> </span>   
			 </td>
   		</tr></table>
