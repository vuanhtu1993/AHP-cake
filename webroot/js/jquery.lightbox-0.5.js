(function($) {
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:		'http://minhhg.com/common/images/others/loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:		'http://minhhg.com/common/images/others/left.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:		'http://minhhg.com/common/images/others/right.gif',			// (string) Path and the name of the next button image
			imageBtnClose:		'http://i664.photobucket.com/albums/vv1/mrbean155/pubblic/close.gif',		// (string) Path and the name of the close btn
			imageBlank:			'http://minhhg.com/common/images/others/spacer.gif',			// (string) Path and the name of a blank image (one pixel)
